...
//        tree1.right = tree5
       ...
       // print(leet.isSymmetric(tree1))//[100,55,65,44,22,32,12,45,67,88,12,34,21,34,56,78]
        ...
        print(leet.paixu([2,4,6,3,1,8,5,7,32,45,5,76,87,7856,4,3423,3,254,65,65,7,75,4,3,45,6,67,875434,5677,78,542,32,323,45,6567,43,]))//[2,4,6,3,5,1]
